...
namespace novatel_oem7
{
  ...
  class Oem7RawMessageIf
  {
    public:
      ...
      virtual ~Oem7RawMessageIf()= default;

      [[nodiscard]] virtual Oem7MessageType            getMessageType()              const = 0;
      [[nodiscard]] virtual Oem7MessageFormat          getMessageFormat()            const = 0;
      [[nodiscard]] virtual int                        getMessageId()                const = 0;
      [[nodiscard]] virtual const uint8_t*             getMessageData(size_t offset) const = 0;
      [[nodiscard]] virtual size_t                     getMessageDataLength()        const = 0;
  };
}
