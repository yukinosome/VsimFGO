...
namespace
{
  ...
  const novatel_oem7::version_element_t VERSION_MAJOR  = 10;
  const novatel_oem7::version_element_t VERSION_MINOR  = 1;
  const novatel_oem7::version_element_t VERSION_SPECIAL= 0;
}
...
namespace novatel_oem7
{
  ...
  public:
    explicit Oem7RawMessage(BaseMessageData* raw_bmd):
      bmd_(raw_bmd)
    {
    }
     ...
     */
    [[nodiscard]] Oem7MessageType   getMessageType() const override
    {
     ...
     */
    [[nodiscard]] Oem7MessageFormat  getMessageFormat() const override
    {
