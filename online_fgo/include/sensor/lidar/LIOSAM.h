...
namespace sensors::LiDAR::LIOSAM
{
    ...
    private:
        ...
        fgo::data::QueryStateOutput queryLiDARPoseFromOptPose(const rclcpp::Time& timestamp)
        {
          ...
          static const auto imuTl = params_.T_lidar_in_IMU;
    ...
    public:
        explicit LIOSAMOdometry(rclcpp::Node& node,
                                ...
                                rclcpp::Publisher<irt_nav_msgs::msg::SensorProcessingReport>::SharedPtr sensorReportPublisher,
                                const gtsam::Pose3 &transFromBase) : node_(node)
        {
