...
namespace fgo::factor {
  ...
  public:
    ...
    GPInterpolatedVSimFactor(gtsam::Key pose_i, gtsam::Key vel_i, gtsam::Key omega_i,
      ...
      // Use latitude and longitude only, ignore height
    ...
    evaluateError(const gtsam::Pose3 &pose_i, const gtsam::Vector3 &vel_i, const gtsam::Vector3 &omega_i,
      ...
      if (useAutoDiff_) {
        if (H1)
          *H1 = gtsam::numericalDerivative61<gtsam::Vector2, gtsam::Pose3, gtsam::Vector3, gtsam::Vector3, gtsam::Pose3, gtsam::Vector3, gtsam::Vector3>(
        ...
        if (H2)
          *H2 = gtsam::numericalDerivative62<gtsam::Vector2, gtsam::Pose3, gtsam::Vector3, gtsam::Vector3, gtsam::Pose3, gtsam::Vector3, gtsam::Vector3>(
            boost::bind(&This::evaluateError_, this, boost::placeholders::_1, boost::placeholders::_2,
                        boost::placeholders::_3, boost::placeholders::_4, boost::placeholders::_5,
                        boost::placeholders::_6),
            pose_i, vel_i, omega_i, pose_j, vel_j, omega_j, 1e-5);
        if (H3)
          *H3 = gtsam::numericalDerivative63<gtsam::Vector2, gtsam::Pose3, gtsam::Vector3, gtsam::Vector3, gtsam::Pose3, gtsam::Vector3, gtsam::Vector3>(
            boost::bind(&This::evaluateError_, this, boost::placeholders::_1, boost::placeholders::_2,
                        boost::placeholders::_3, boost::placeholders::_4, boost::placeholders::_5,
                        boost::placeholders::_6),
            pose_i, vel_i, omega_i, pose_j, vel_j, omega_j, 1e-5);
        if (H4)
          *H4 = gtsam::numericalDerivative64<gtsam::Vector2, gtsam::Pose3, gtsam::Vector3, gtsam::Vector3, gtsam::Pose3, gtsam::Vector3, gtsam::Vector3>(
            boost::bind(&This::evaluateError_, this, boost::placeholders::_1, boost::placeholders::_2,
                        boost::placeholders::_3, boost::placeholders::_4, boost::placeholders::_5,
                        boost::placeholders::_6),
            pose_i, vel_i, omega_i, pose_j, vel_j, omega_j, 1e-5);
        if (H5)
          *H5 = gtsam::numericalDerivative65<gtsam::Vector2, gtsam::Pose3, gtsam::Vector3, gtsam::Vector3, gtsam::Pose3, gtsam::Vector3, gtsam::Vector3>(
            boost::bind(&This::evaluateError_, this, boost::placeholders::_1, boost::placeholders::_2,
                        boost::placeholders::_3, boost::placeholders::_4, boost::placeholders::_5,
                        boost::placeholders::_6),
            pose_i, vel_i, omega_i, pose_j, vel_j, omega_j, 1e-5);
        if (H6)
          *H6 = gtsam::numericalDerivative66<gtsam::Vector2, gtsam::Pose3, gtsam::Vector3, gtsam::Vector3, gtsam::Pose3, gtsam::Vector3, gtsam::Vector3>(
            boost::bind(&This::evaluateError_, this, boost::placeholders::_1, boost::placeholders::_2,
                        boost::placeholders::_3, boost::placeholders::_4, boost::placeholders::_5,
                        boost::placeholders::_6),
            pose_i, vel_i, omega_i, pose_j, vel_j, omega_j, 1e-5);
        ...
        return evaluateError_(pose_i, vel_i, omega_i, pose_j, vel_j, omega_j);
      }
      return evaluateError_(pose_i, vel_i, omega_i, pose_j, vel_j, omega_j);
    }

    [[nodiscard]] gtsam::Vector2
    evaluateError_(const gtsam::Pose3 &pose_i, const gtsam::Vector3 &vel_i, const gtsam::Vector3 &omega_i,
      ...
      const auto pos_ecef = pose.translation() + pose.rotation().rotate(lb_);
      const auto llh = fgo::utils::xyz2llh(pos_ecef);
    ...
    bool equals(const gtsam::NonlinearFactor &expected, double tol = 1e-9) const override {
      ...
      return e != nullptr && Base::equals(*e, tol)
              && gtsam::equal_with_abs_tol((gtsam::Vector2() << this->ll_).finished(),
                  (gtsam::Vector2() << e->ll_).finished(), tol);
    }
  ...
  private:
    ...
    void serialize(ARCHIVE &ar, const unsigned int version) {
      ...
      ar & BOOST_SERIALIZATION_NVP(ll_);
    }
