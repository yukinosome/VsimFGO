...
namespace gnss_fgo {
        ...
        : GNSSFGOLocalizationBase("GNSSFGOTimeCentricNode", opt)
    {
      ...
      if (!paramsPtr_->offlineProcess) {
        callbackGroupMap_.insert(std::make_pair("PVTDelayCalculator", this->create_callback_group(
          rclcpp::CallbackGroupType::MutuallyExclusive)));
        callbackGroupMap_.insert(
          std::make_pair("PPS", this->create_callback_group(rclcpp::CallbackGroupType::MutuallyExclusive)));
        callbackGroupMap_.insert(
          std::make_pair("PVT", this->create_callback_group(rclcpp::CallbackGroupType::MutuallyExclusive)));
        ...
        subPVA_ = this->create_subscription<irt_nav_msgs::msg::PVAGeodetic>("/irt_gnss_preprocessing/PVT",
                                                                            ...
                                                                            [this](
                                                                              const irt_nav_msgs::msg::PVAGeodetic::ConstSharedPtr pvtMsg) -> void {
      ...
      pubUserEstimationTimer_ = this->create_wall_timer(std::chrono::milliseconds(10),
                                                        [this]()->void
                                                        {
                                                            ...
                                                            fgo::data::UserEstimation_T user_est = userEstimationBuffer_.get_last_buffer();
    ...
    void GNSSFGOTimeCentricNode::onPVAMsgCb(const irt_nav_msgs::msg::PVAGeodetic::ConstSharedPtr pvaMsg)
    {
        ...
        referenceBuffer_.update_buffer(pva, pvaTime);
